    ...
    <div class="flex flex-col items-center justify-center mt-10">
        <div
            ...
            <form class="space-y-6" action="{{route('articulos.store')}}" method="POST" enctype="multipart/form-data">
                <h5 class="text-4xl font-medium text-gray-900 dark:text-white">Crear Articulo</h5>
                @csrf
                @if ($errors->any())
                ...
                <div>
                    ...
                    <input
                        class="block w-full text-xl text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                ...
                <div class="flex items-start justify-center gap-4">
                    ...
                    <button type="submit"
                    <button type="button" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Crear Articulo</button>
                </div>
            </form>
        </div>
