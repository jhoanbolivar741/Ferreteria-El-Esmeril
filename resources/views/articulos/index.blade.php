<x-app-layout>
    <x-slot name="header">
        <h2
            class="p-4 bg-lime-100 dark:bg-lime-500 font-semibold text-3xl text-gray-800 dark:text-gray-200 leading-tight text-center rounded-lg">
            {{ __('Articulos') }}
        </h2>
    </x-slot>
    <div class="p-8">
        ...
        <form method="GET" action="{{ route('articulos.index') }}" class="mb-4">
            <label for="search" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Buscar por
                descripción, cantidad, precio unitario o unidad</label>
            <div class="relative">
                ...
                <input type="search" id="search" name="search" value="{{ request('search') }}"
                    ...
                    placeholder="Buscar por descripción, cantidad, precio unitario o unidad" />
                <button type="submit"
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xl text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-100">
                    <tr>
                        ...
                        <th scope="col" class="bg-lime-300 dark:bg-lime-600 py-2 text-right">
                            ...
                            @can('reporte.inventario')
                                <a href="{{ route('reporte.inventario') }}">
                                    <button type="button"
                                        class="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Inventario</button>
                                </a>
                            @endcan
                        </th>
                    </tr>
