<x-app-layout>
<x-slot name="header">
        <h2 class="p-4 bg-lime-100 font-semibold text-3xl text-gray-800 dark:text-gray-200 leading-tight text-center">
            {{ __('Articulos') }}
        </h2>
    </x-slot>
    <div class="p-8">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xl text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="bg-lime-300 px-6 py-3">
                            ID
                        </th>
                        <th scope="col" class="bg-lime-300 px-6 py-3">
                            Descripción
                        ...
                        <th scope="col" class="bg-lime-300 pr-20 py-2 text-right">
