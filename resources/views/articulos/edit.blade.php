<x-app-layout>
    <div class="flex flex-col items-center justify-center mt-10">
        <div
            ...
            <form class="space-y-6" action="{{route('articulos.update',[$articulo])}}" method="POST">
                @method('PUT')
                ...
                <div>
                    <label for="unidad_id"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Unidad Id</label>
